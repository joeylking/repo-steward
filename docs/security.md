...
| Repository content sent to the model | Local models only during development; a paid provider, when added, is used for one explicit budgeted measurement and never in tests or CI | Implemented as policy | README |
